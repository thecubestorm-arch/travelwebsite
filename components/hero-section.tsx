      ...
      <div className="relative max-w-3xl">
        ...
        <div className="mt-10 flex flex-col gap-4 sm:flex-row">
          <Link
            ...
            className="accent-ring inline-flex min-h-12 items-center justify-center rounded-full bg-[var(--accent)] px-6 py-3 text-sm font-semibold text-white hover:-translate-y-0.5 hover:bg-[var(--accent-strong)]"
          >
            {primaryCta.label}
          </Link>
          {secondaryCta ? (
